// =============================================================================
//
//  app/components/ap-password-validator/ap-password-validator.spec.js
//
// =============================================================================
...
import apPasswordValidator from './ap-password-validator';

describe('apPasswordValidator', () => {
  let $scope;
  let form;

  beforeEach(
    angular.mock.module(apPasswordValidator),
  );
