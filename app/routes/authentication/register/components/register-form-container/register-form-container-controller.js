...
/**
 * AlrRegisterFormContainerController class handles our interaction with the user register component
 *
 * @class AlrRegisterFormContainerController
 */
class AlrRegisterFormContainerController {

  /**
   * Constructor for the AlrRegisterFormContainerController class
   *
   * @constructor
...
export default AlrRegisterFormContainerController;
